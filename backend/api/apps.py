...
def startup():
    ...
    try:
        ...
        ccprog1s16 = CourseOffering(faculty=bob, course=ccprog1, section=s16, day=monday, timeslot=time1100, room=goks201, term=2, start_AY=19, end_AY=20, current_enrolled=0, max_enrolled=40, status=True)
        ccprog1s15.save()
        ccprog1s16.save()
        ccprog1s15 = CourseOffering(faculty=fritz, course=ccprog1, section=s15, day=wednesday, timeslot=time915, room=goks201, term=2, start_AY=19, end_AY=20, current_enrolled=0, max_enrolled=40, status=True)
        ccprog1s16 = CourseOffering(faculty=bob, course=ccprog1, section=s16, day=wednesday, timeslot=time1100, room=goks201, term=2, start_AY=19, end_AY=20, current_enrolled=0, max_enrolled=40, status=True)
        ccprog1s15.save()
        ccprog1s16.save()

        ccprog2s15 = CourseOffering(faculty=fritz, course=ccprog2, section=s15, day=tuesday, timeslot=time915, room=goks201, term=2, start_AY=19, end_AY=20, current_enrolled=0, max_enrolled=40, status=True)
        ccprog2s16 = CourseOffering(faculty=bob, course=ccprog2, section=s16, day=tuesday, timeslot=time1100, room=goks201, term=2, start_AY=19, end_AY=20, current_enrolled=0, max_enrolled=40, status=True)
        ccprog2s15.save()
        ccprog2s16.save()
        ccprog2s15 = CourseOffering(faculty=fritz, course=ccprog2, section=s15, day=thursday, timeslot=time915, room=goks201, term=2, start_AY=19, end_AY=20, current_enrolled=0, max_enrolled=40, status=True)
        ccprog2s16 = CourseOffering(faculty=bob, course=ccprog2, section=s16, day=thursday, timeslot=time1100, room=goks201, term=2, start_AY=19, end_AY=20, current_enrolled=0, max_enrolled=40, status=True)
        ccprog2s15.save()
        ccprog2s16.save()

        humaarts15 = CourseOffering(faculty=fritz, course=humaart, section=s15, day=monday, timeslot=time915, room=goks201, term=2, start_AY=19, end_AY=20, current_enrolled=0, max_enrolled=40, status=True)
        humaarts16 = CourseOffering(faculty=bob, course=humaart, section=s16, day=monday, timeslot=time1100, room=goks201, term=2, start_AY=19, end_AY=20, current_enrolled=0, max_enrolled=40, status=True)
        humaarts15.save()
        humaarts16.save()
        humaarts15 = CourseOffering(faculty=fritz, course=humaart, section=s15, day=wednesday, timeslot=time915, room=goks201, term=2, start_AY=19, end_AY=20, current_enrolled=0, max_enrolled=40, status=True)
        humaarts16 = CourseOffering(faculty=bob, course=humaart, section=s16, day=wednesday, timeslot=time1100, room=goks201, term=2, start_AY=19, end_AY=20, current_enrolled=0, max_enrolled=40, status=True)
        humaarts15.save()
        humaarts16.save()

        greatwks15 = CourseOffering(faculty=fritz, course=greatwk, section=s15, day=tuesday, timeslot=time915, room=goks201, term=2, start_AY=19, end_AY=20, current_enrolled=0, max_enrolled=40, status=True)
        greatwks16 = CourseOffering(faculty=bob, course=greatwk, section=s16, day=tuesday, timeslot=time1100, room=goks201, term=2, start_AY=19, end_AY=20, current_enrolled=0, max_enrolled=40, status=True)
        greatwks15.save()
        greatwks16.save()
        greatwks15 = CourseOffering(faculty=fritz, course=greatwk, section=s15, day=thursday, timeslot=time915, room=goks201, term=2, start_AY=19, end_AY=20, current_enrolled=0, max_enrolled=40, status=True)
        greatwks16 = CourseOffering(faculty=bob, course=greatwk, section=s16, day=thursday, timeslot=time1100, room=goks201, term=2, start_AY=19, end_AY=20, current_enrolled=0, max_enrolled=40, status=True)
        greatwks15.save()
        greatwks16.save()
